...
const ServiceTabs: React.FC<ServiceTabsProps> = ({ tabs, activeTab, onChange }) => {
    return (
        <div className="flex justify-center mb-8 md:mb-12">
            <div className="inline-flex p-1 bg-white/50 border border-cyan-100 rounded-xl overflow-x-auto relative whitespace-nowrap">
                {tabs.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            className={`relative px-4 md:px-6 lg:px-8 py-2 md:py-3 text-sm md:text-base  rounded-lg  transition-colors duration-300  ${
